...
public class SecurityConfig {	
	...
	protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.and()
			.csrf().disable()    //csrf: Cross side request is a protection  against data in springBoot it is automatically enebled
								//it unable to perform put mapping , get mapping
								//so you need to disabled it
			.formLogin()
